...
<div class="crt-frame">
	<div class="brand w-full text-center text-gray-400 pb-2">iWatt</div>
	<div use:setupTerminal class="mb-6 h-full w-full"></div>
...
<style>
	.crt-frame {
		...
		padding: 1rem;
		border-radius: 16px;
		background: radial-gradient(circle at center, #808080 0%, #4d4d4d 100%);
		box-shadow:
			0 0 20px #000,
			inset 0 0 20px #888,
			inset 0 0 4px #b3b3b3; /* subtle highlight */
	}
